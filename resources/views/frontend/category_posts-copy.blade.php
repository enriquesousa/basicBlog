...
@section('title')
basicBlog | Categoría | EsWeb
@endsection

    <!-- main-area -->
    <main>

        <!-- Titulo: Lista Blogs por Categoría -->
                        ...
                        <div class="breadcrumb__wrap__content">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Lista Blogs por Categoría</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        ...
                        <aside class="blog__sidebar">
                            ...
                            {{-- Blog Recientes --}}
                            <div class="widget">
                                <h4 class="widget-title">Blog Recientes</h4>
                                <ul class="rc__post">
