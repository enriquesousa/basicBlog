...
@endsection
    ...
    <main>
        ...
        <!-- Forma de Contacto - contact-area -->
        ...
        $(document).ready(function() {
            $('#myForm').validate({
                ...
                messages: {
                    ...
                    email: {
                        required: 'Favor de Ingresar su Email',
                    },
                    subject: {
                        required: 'Favor de Ingresar el Asunto',
                    },
                    phone: {
                        required: 'Favor de Ingresar su Teléfono',
                    },
                    message: {
                        required: 'Favor de Ingresar su Mensaje',
                    },
