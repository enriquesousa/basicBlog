            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Agregar <strong>Editar Categoría del Blog</strong></h4>
                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ route('update.blog.category') }}" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" name="blog_category" type="text" value="{{ $blogCategory->blog_category }}" autofocus>
                                        @error('blog_category')
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <button type="submit" class="btn btn-primary waves-effect waves-light"><i class="ri-save-3-line"></i> Actualizar Categoría</button>
                                    </div>
                                </div>
