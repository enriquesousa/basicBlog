@if ($paginator->hasPages())
    ...
    <nav aria-label="Page navigation example">
        <ul class="pagination">
            ...
            {{-- Pagina Anterior - Previous Page Link --}}
            ...
            {{-- Pagina Siguiente - Next Page Link --}}
...
{{-- Nota:
    Esta es la estructura de la pagination de la plantilla.
    Incorporar las clases y a links a la estructura de la pagination que nos ofrece 
    laravel en resources/views/vendor/pagination/default.blade.php
--}}
